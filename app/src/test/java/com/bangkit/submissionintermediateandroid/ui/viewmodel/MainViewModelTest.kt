...
import com.bangkit.submissionintermediateandroid.DataDummy
import com.bangkit.submissionintermediateandroid.MainDispatcherRule
...
import com.bangkit.submissionintermediateandroid.getOrAwaitValue
...
class MainViewModelTest {
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(userRepository.getAllStories()).thenReturn(expectedStory)
